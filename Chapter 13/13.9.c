/* ћодифицируйте программу в листинге 13.3, чтобы каждое слово было пронумеровано
в соответствии с пор€дком его добавлени€ в список, начина€ с 1.
ѕозаботьтесь о том, чтобы при втором запуске программы нова€ нумераци€
слов начиналась с того места, где была закончена пумераци€ при предыдущем
запуске. */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
